    ...
    <section className="hero-container">
      ...
      <div className="hero-content">
        ...
        <div className="hero-center-section">
          <h1 className="hero-title">
            <span className="hero-title-line-1">
              Think Forward<span className="hero-registered">®</span>
            </span>
        ...
        <div className="hero-bottom-row">
          <div className="hero-meta-item text-left">May 15-17</div>
          <div className="hero-meta-item text-center">Nova Center</div>
          <div className="hero-meta-item text-right">London</div>
        </div>
      </div>
    </section>
  );
